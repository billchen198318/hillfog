...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td bgcolor="#000000" style="border-top-right-radius: 5px;"><font color="#FFFFFF" size="5"><strong>No permission:</strong></font></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#E9D8D8" style="border-bottom-right-radius: 5px;">&nbsp;</td>
  </tr>
</table>
