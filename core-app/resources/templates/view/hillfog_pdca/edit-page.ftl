...
var pdcaOid = '${pdca.oid}';
var masterType = '${pdca.mstType}';
...
$( document ).ready(function() {
	...
	<@qifu.if test=" null != pdca.ownerNameList && pdca.ownerNameList.size > 0 ">
	<#list pdca.ownerNameList as owner>
	selEmpList.push( '${owner?js_string?html}' );
	</#list>
	paintEmployee();
	</@qifu.if>
	...
	uploadAttc.push( {'oid' : '${attc.uploadOid}', 'name' : '${attc.showName?js_string?html}'} );
	</#list>
	paintAttc();
	</@qifu.if>
...
<div class="form-group" id="form-group1">
	<div class="row">
		...
		<@qifu.if test=" \"K\" == pdca.mstType ">
			...
			<div class="row">
				<div class="col-xs-12 col-md-12 col-lg-12 text-white">
					<span class="btn badge btn-info" onclick="btnUpdate();"><h6><i class="icon fa fa-floppy-o"></i>&nbsp;Update</h6></span>
					&nbsp;
	...
	<div class="row">
		<div class="col-xs-6 col-md-6 col-lg-6">
			PDCA Number:<br><span class="badge badge-success">${pdca.pdcaNum}</span>
		</div>
		<div class="col-xs-6 col-md-6 col-lg-6">
			<@qifu.textbox type="text" name="name" value="pdca.name" id="name" label="Name" requiredFlag="Y" maxlength="100" placeholder="Enter name" />
		</div>		
	</div>		
	
	<div class="row">
		<div class="col-xs-6 col-md-6 col-lg-6">
			<@qifu.textbox type="date" name="startDate" value="pdca.startDateShow" id="startDate" label="Start" requiredFlag="Y" maxlength="10" placeholder="Enter start date" />
		</div>
		<div class="col-xs-6 col-md-6 col-lg-6">
			<@qifu.textbox type="date" name="endDate" value="pdca.endDateShow" id="endDate" label="End" requiredFlag="Y" maxlength="10" placeholder="Enter end date" />
		</div>		
	</div>	
...
<div class="form-group" id="form-group3">
	<div class="row">
		<div class="col-xs-12 col-md-12 col-lg-12">
			<@qifu.textarea name="description" value="pdca.description" id="description" label="Description" rows="3" placeholder="Enter description"></@qifu.textarea>
		</div>
	</div>
...
<script type="text/javascript" src="${qifu_basePath}js/hillfog/HF_PROG004D0001E.js?ver=${qifu_jsVerBuild}"></script>
