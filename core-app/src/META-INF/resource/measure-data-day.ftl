		...
		<#list day..7 as d >		<!-- 每列7日 -->
			...
			<#if (count >= dayOfWeek) && (dayCount <= maxday) >		<!-- 資料起於當月開始日(dayOfWeek), 並迄於當月最大日(maxday) -->				
				...
				<td bgcolor="#FFFFFF" align="center">
					...
					<br/>
		      		<input type="text" class="form-control" name="MEASURE_DATA_TARGET:${dayStr}" id="MEASURE_DATA_TARGET:${dayStr}" value="${targetValue}" maxlength="12" placeholder="Enter target"></input>
		      		<br/>
		      		<input type="text" class="form-control" name="MEASURE_DATA_ACTUAL:${dayStr}" id="MEASURE_DATA_ACTUAL:${dayStr}" value="${actualValue}" maxlength="12" placeholder="Enter actual"></input>
		      		<br/>	
