...
<table class="table table-bordered">			
	...
	<tr>
		<td bgcolor="#FFFFFF" align="center">
			...
			<br/>
		    <input type="text" class="form-control w-75" name="MEASURE_DATA_TARGET:${yyyy}0101" id="MEASURE_DATA_TARGET:${yyyy}0101" value="${targetValue}" maxlength="12" placeholder="Enter target"></input>
			<br/>
			<input type="text" class="form-control w-75" name="MEASURE_DATA_ACTUAL:${yyyy}0101" id="MEASURE_DATA_ACTUAL:${yyyy}0101" value="${actualValue}" maxlength="12" placeholder="Enter actual"></input>
			<br/>	
		...
		<td bgcolor="#FFFFFF" align="center">
			...
			<br/>
		    <input type="text" class="form-control w-75" name="MEASURE_DATA_TARGET:${yyyy}0701" id="MEASURE_DATA_TARGET:${yyyy}0701" value="${targetValue}" maxlength="12" placeholder="Enter target"></input>
			<br/>
			<input type="text" class="form-control w-75" name="MEASURE_DATA_ACTUAL:${yyyy}0701" id="MEASURE_DATA_ACTUAL:${yyyy}0701" value="${actualValue}" maxlength="12" placeholder="Enter actual"></input>
			<br/>	
